    ...
    <header className="sticky top-0 z-30 bg-slate-950/95 shadow-xl shadow-slate-950/10 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
        <div className="w-full">
          <Button variant="ghost" type="button" aria-label="Menu">
        ...
        <form className="flex w-full max-w-3xl" onSubmit={handleSearch}>
        ...
        <div className="ml-auto flex items-center gap-2 w-full justify-end">
          <Button variant="ghost" type="button"  aria-label="Cart">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Button variant="ghost" type="button"  aria-label="Account">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
